...
Ext.ss.form.LovField = Ext.extend(Ext.form.TriggerField, {
    ...
    ENTER: 'Enter',
    lovTitle: __commonMessages['List of value'],
    lovWidth: 400,
    lovHeight: 375,
    isShowLov: false,
    isGridEditor: false,
    ...
    noDataFoundMessage: __commonMessages['No Data Found'],
    searchValueIsRequiredMessage: __commonMessages['Search Value is required.'],
    closeBtnText: __commonMessages['Close'],
    searchFieldLabel: __commonMessages['Search value'],
    zIndex: undefined,
    /**
     * Store properties
     */
     ...
     */
    valueHeader: __commonMessages['Code'],
    descriptionHeader: __commonMessages['Description'],
    codeAlign: 'center',
