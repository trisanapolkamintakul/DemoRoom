...
CREATE TABLE `room_type` (
  `RTID` int(10) NOT NULL AUTO_INCREMENT,
  `RTNAME` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`RTID`)
...
INSERT INTO `room_type` VALUES (1,'Study Room'),(2,'Meeting Room'),(3,'Activity Room');
